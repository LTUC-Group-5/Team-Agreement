...
### Ayman: server and CRUD App
### Firas: SQL and Express
### Zekra : Backend and css styling
### Ibraheem: Frontend react 
### Sajeda: Frontend React Bootstrap
## - How can you best utilize these strengths in the execution of your project?
Assigning the right task to the right person.
## - In which professional competencies do you each want to develop greater strength?
Ayman: front end responsive design and CSS styles
Firas: react and CSS styles
Zekra: front end react 
Ibraheem: SQL Postgres
Sajeda: backend express

## - Knowing that every person in your team needs to understand all aspects of the project, how do you plan to approach the day-to-day work?
By attending a meeting to assign tasks and discussing the details of our plan for the next day.

# Conflict Plan
## Your team should agree on a process for handling disagreements, should they arise. It is better to have a plan in place ahead of time so you can all refer back to it when necessary.
## Describe at least:
## - What will be your group's process to resolve conflict, when it arises?
Depending on the situation we will be voting or we will counsel a TA.
## - What will your team do if one person is taking over the project and not letting the other members contribute?
We will talk to the person and if he/she didn't cooperate will complain to the TA as a last resort.
